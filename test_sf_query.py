#!/usr/bin/env python3
"""
Test San Francisco query specifically
"""
...
from main import extract_search_intent, extract_detailed_criteria, choose_search_method, get_exact_matches

async def test_sf_query():
    """Test the San Francisco query specifically"""
    ...
    try:
        ...
        if listings:
            ...
            # Test rule-based scoring on first listing
            from main import calculate_rule_based_score
            listing = listings[0]
            score, matched_criteria, unmatched_criteria = calculate_rule_based_score(listing, criteria_list)
            
            print(f"\nRule-based scoring for first listing:")
